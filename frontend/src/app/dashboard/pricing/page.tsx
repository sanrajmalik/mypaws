...
function PricingContent() {
    ...
    // ... inside handlePurchase or equivalent logic
    // If it's the specific case of "Adoption Free Plan" AND "New Listing (already active)",
    ...
    // Auto-switch tab based on type param
                // Using a small effect to avoid infinite loop if not careful, but setState checking equality is safe
                        ...
                        <div className="container mx-auto py-10 px-4 max-w-6xl">
                            <div className="text-center mb-12">
                                ...
                                <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                                    Choose the perfect plan for your needs. Whether you're rehoming a pet or a professional breeder, we have you covered.
                                </p>
                            </div>
                                ...
                                {activeTab === 'adopter' ? (
                                    <div className="grid md:grid-cols-3 gap-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
                                        <PricingCard
                                            ...
                                            onSelect={() => handlePurchase('adoption', 'free', 0)}
                                            disabled={loading === 'adoption-free'}
                                        />
                                        <PricingCard
                                            title="Standard"
